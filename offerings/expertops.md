...
Percona engineers perform operational work directly in your environment: monitoring, tuning, patching, automation, backup validation, and routine maintenance, using PMM for observability and Operators plus engine-appropriate tooling for execution. Unlike [Expert Support](expert-support/messaging.md), ExpertOps is proactive and hands-on: Percona executes operational work rather than advising your team to execute it. For subscription deliverables, SLAs, and onboarding detail, see the [ExpertOps service catalog](expertops/service-catalog.md).
