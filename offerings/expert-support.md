...
Expert Support provides 24×7 incident response, troubleshooting, and advisory guidance for MySQL, MariaDB, PostgreSQL, MongoDB, and Valkey/Redis. Percona engineers help diagnose issues, review customer plans, validate configurations, and guide customers through critical problems, while the customer maintains operational control.

**MariaDB (Community) scope.** Expert Support for MariaDB applies to **MariaDB Community** within Percona's published support scope. It does not cover MariaDB Enterprise or other non-Community editions under standard Support entitlements. For other MariaDB versions, complex topologies, or programs to move to Percona Server for MySQL, use **Expert Consulting and Services**. Percona does not develop MariaDB database software. See [MariaDB support](https://www.percona.com/services/support/mariadb-support).
