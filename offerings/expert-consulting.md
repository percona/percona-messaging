...
- **Legacy RDBMS migration to open source:** Assessment-led projects when license, support, or vendor roadmap risk drives the case. Typical targets include open source PostgreSQL, MySQL, or MariaDB (Community) within Percona's MariaDB scope. Source-to-target combinations and execution depth are scoped and quoted after assessment, not assumed for every engine pair.
