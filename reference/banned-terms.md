...
| post-EOL support, Post-EOL Support, Percona EOL Support, Extended Life Support | **Extended Lifecycle Support (ELS)** | Program name for MySQL, MongoDB, and MariaDB Community post-EOL coverage. EOL alone is deadline state, not the program SKU. |
