...
- Enterprise parity: Audit logging (including Audit Log Filter), PAM / LDAP / FIDO authentication, Data masking, Thread pool, External key management (HashiCorp Vault, KMIP, AWS KMS keyring), FIPS mode (standard PS and PXC builds from 8.4.0-5 onward).
