...
- MariaDB Galera Cluster end of life: MariaDB has announced 2026-09-30 as the end of life for maintenance and regular binary releases of MariaDB Galera Cluster. Teams already on **Percona XtraDB Cluster** need no migration: PXC is built on Percona's own Galera fork, and support, releases, security patches, and long-term support continue on the same Percona lifecycle terms customers already rely on. Organizations still on **MariaDB Galera Cluster** should plan a move to Percona XtraDB Cluster or MySQL Group Replication through Percona software and operators before that date ([continued commitment to Percona XtraDB Cluster](https://www.percona.com/blog/continued-commitment-to-percona-xtradb-cluster/)).
...
- Are you on MariaDB Galera Cluster and tracking its 2026-09-30 end of life? (PXC customers need no migration. Teams still on MariaDB Galera Cluster should plan a move to PXC or Group Replication with Percona software, operators, and Expert Support.)
