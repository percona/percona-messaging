...
For organizations running MariaDB in production, Percona helps teams get more value from **MariaDB Community**. That means steadier day-to-day operations, clearer cost and support boundaries, stronger performance and reliability practices, and security that fits how the estate already runs. Percona does this with **Expert Support**, **Extended Lifecycle Support (ELS)** when Community versions approach or pass End of Life (EOL), **Expert Consulting and Services** for complex environments, and **Percona ExpertOps** when teams want operational ownership. Teams do not need to change platforms to start.
...
Percona does not ship MariaDB database software. Percona supports **MariaDB Community** in production with the same upstream-level engineering depth applied across MySQL, PostgreSQL, MongoDB, and Valkey. **Expert Support** covers **MariaDB Community versions only**, not MariaDB Enterprise editions under standard Support entitlements. **Extended Lifecycle Support (ELS)** applies to qualifying Community versions approaching or past EOL as a bridge to a supported release. **Expert Consulting and Services** may apply to other MariaDB versions and complex environments. See [MariaDB support](https://www.percona.com/services/support/mariadb-support).

### Customer Challenges and Value Alignment – MariaDB

**Optimized TCO**

- **Extended Lifecycle Support (ELS) for MariaDB Community:** When MariaDB Community versions near or pass End of Life (EOL), teams face higher security, compliance, and support risk if they stay with no continuity plan, or costly rush upgrades if they move under deadline pressure. Percona offers **Extended Lifecycle Support (ELS)** for MariaDB Community as a bridge: continued production coverage and a clear path to a supported Community release on the team's timeline. ELS is not a replacement for moving to a supported version, and it does not mean Percona ships MariaDB database software.
- **MySQL Galera Cluster end of life (adjacent estates):** MariaDB has announced 2026-09-30 as the end of life for maintenance and regular binary releases of **MySQL Galera Cluster**. For teams on MySQL Galera Cluster (not MariaDB Galera), **Percona XtraDB Cluster** is the natural Galera-to-Galera path ([continued commitment to Percona XtraDB Cluster](https://www.percona.com/blog/continued-commitment-to-percona-xtradb-cluster/)). Teams already on MariaDB Community stay in the MariaDB Support, ELS, and consulting motion above.
...
Percona helps MariaDB Community environments run in production with Expert Support, **Extended Lifecycle Support (ELS)** when Community versions near or pass EOL, and optional ExpertOps. Consulting covers complex or non-Community environments. Teams get more reliability, clarity, and operational depth on MariaDB, without Percona claiming to ship MariaDB software.

**Purpose**

MariaDB Community is a lasting production path, not a short stop on the way to MySQL. Teams need honest Community Support scope, ELS when versions near or pass EOL, consulting when the environment is broader or outside Community entitlements, and ExpertOps when teams want operational ownership. Percona meets those needs on MariaDB with clear boundaries: Community-only Expert Support and ELS, no Percona MariaDB database software, and engine-change work only when the customer asks for a different home.

**Conversation starters**

- Are you running MariaDB Community or Enterprise in production today, and which versions matter for Support scope? (Expert Support and ELS cover MariaDB Community only; non-Community surfaces need consulting scope so entitlements stay honest.)
- Which Community versions are approaching or past End of Life (EOL), and do you need runway before an upgrade finishes? (ELS is a bridge to a supported Community release on the team's timeline, not a permanent stay on EOL.)
...
- Are you on MySQL Galera Cluster (not MariaDB Galera) with a 2026 maintenance cliff in view? (Adjacent estate only: PXC is the Galera-to-Galera path; MariaDB Community stays on the MariaDB Support / ELS / consulting motion.)
...
- [Continued commitment to Percona XtraDB Cluster](https://www.percona.com/blog/continued-commitment-to-percona-xtradb-cluster/) (for MySQL Galera Cluster EOL estates only)
