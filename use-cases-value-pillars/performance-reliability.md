...
- **Resilient observability:** PMM HA Cluster keeps dashboards, alerts, Query Analytics, and advisors reachable through PMM Server failures and maintenance. Docker HA and Kubernetes single-instance HA cover deployments where a short failover gap is acceptable; HA Cluster fits environments that need immediate failover instead.
