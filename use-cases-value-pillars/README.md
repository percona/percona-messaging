...
- [cost-optimization.md](cost-optimization.md) (use cases: proprietary licensing, DBA talent shortage, extended lifecycle support (ELS), vendor consolidation, reduce cloud spend, workload tuning and rightsizing)
