...
- [cost-optimization.md](cost-optimization.md) (use cases: proprietary licensing, extended lifecycle support (ELS), vendor consolidation, reduce cloud spend, workload tuning and rightsizing; private fork labor vs supported upstream for product manufacturers, uncommon)
...
- [security-sovereignty-compliance.md](security-sovereignty-compliance.md) (use cases: audit-ready, data governance, regional data residency, US extraterritorial access risk, multi-tenant isolation, EU software supply chain compliance; sovereignty evidence table)
- [future-readiness-ai.md](future-readiness-ai.md) (use cases: RAG on PostgreSQL, vector search on Valkey, retrieval for agent workflows on databases you already run)
