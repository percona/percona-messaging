...
- [cost-optimization.md](cost-optimization.md) (use cases: proprietary licensing, extended lifecycle support (ELS), vendor consolidation, reduce cloud spend, workload tuning and rightsizing, legacy migration and modernization to open source)
