...
- [cost-optimization.md](cost-optimization.md) (use cases: legacy migration and modernization to open source, proprietary licensing drag, DBA talent shortage, database end-of-life migration (MySQL 8.0 EOL), reduce database vendor sprawl, cut cloud database costs, workload tuning and rightsizing)
