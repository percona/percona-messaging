...
- [performance-reliability.md](performance-reliability.md) (use cases: business continuity, peak traffic)
- [security-sovereignty-compliance.md](security-sovereignty-compliance.md) (use cases: residency, audit evidence, multi-tenant isolation; sovereignty evidence table)
- [future-readiness-ai.md](future-readiness-ai.md) (use cases: vector search, hybrid AI pipelines, self-managed DBaaS replacing cloud DBaaS)
