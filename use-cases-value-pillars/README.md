...
- [cost-optimization.md](cost-optimization.md) (use cases: proprietary licensing, extended life support (ELS), vendor consolidation, reduce cloud spend, workload tuning and rightsizing)
